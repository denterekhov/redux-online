...
/******/ 	__webpack_require__.p = "/redux-online/";
/******/
/******/
...
exports.SHOW_SELECTED_PHOTO = exports.SHOW_PREVIOUS_PHOTO = exports.SHOW_NEXT_PHOTO = void 0;
const SHOW_NEXT_PHOTO = 'SHOW_NEXT_PHOTO';
exports.SHOW_NEXT_PHOTO = SHOW_NEXT_PHOTO;
const SHOW_PREVIOUS_PHOTO = 'SHOW_PREVIOUS_PHOTO';
exports.SHOW_PREVIOUS_PHOTO = SHOW_PREVIOUS_PHOTO;
...
let Gallery = (_dec = (0, _reactHotLoader.hot)(module), _dec(_class2 = class Gallery extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_showPreviousPhoto", () => {
      _store.store.dispatch((0, _actions.showPreviousPhoto)());
  ...
  render() {
    ...
    return _react.default.createElement("section", {
      ...
      onClick: this._showPreviousPhoto
...
// extracted by mini-css-extract-plugin
module.exports = {"buttonActive":"styles-m__buttonActive---2kcWt","gallery":"styles-m__gallery---3Y1cp"};
...
const composeEnhancers = devtools ? devtools : _redux.compose;
const enhancedStore = composeEnhancers((0, _redux.applyMiddleware)(logger));
const store = preloadedState ? (0, _redux.createStore)(_rootReducer.rootReducer, preloadedState, enhancedStore) : (0, _redux.createStore)(_rootReducer.rootReducer, enhancedStore);
exports.store = store;
store.subscribe(() => {
...
const galleryReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case _types.SHOW_PREVIOUS_PHOTO:
...
exports.showSelectedPhoto = exports.showPreviousPhoto = exports.showNextPhoto = void 0;
...
const showPreviousPhoto = () => {
  return {
    type: _types.SHOW_PREVIOUS_PHOTO
  };
};

exports.showPreviousPhoto = showPreviousPhoto;
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.fbcf7.js.map